...
import {Map, KeyboardControl,ZoomControl,MouseControl,CompassControl,MarkerLayer, MarkerCardConfiguration} from 'react-mapycz';
...
const Mapa: React.FC<MarkersListProps> = ({oblasti}) =>{
    return(  
    <Map height="750px" center={{lat: 50.0968800, lng: 16.6379681}}>
      <KeyboardControl/>
      <ZoomControl/>
